...
plt.vlines(df.NU_NOTA_LC.mean(),0,50,color='r',label='Média')
plt.title('Linguagens e códigos - 2019')
plt.legend()
...
plt.vlines(df.NU_NOTA_CH.mean(),0,35,color='r',label='Média')
plt.title('Ciências Humanas - 2019')
plt.legend()
...
plt.vlines(df.NU_NOTA_CN.mean(),0,28,color='r',label='Média')
plt.title('Ciências da Natureza - 2019')
plt.legend()
